...
You will write Arduino code that incorporates all the following elements. Upload your `.ino` file on the course's Moodle page. You'll have two weeks until deadline.
